const Tech = () => {
  return (
    <div className="max-w-sm w-full mx-auto group">
      <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
        ...
        <div className="w-10 h-32 top-1/2 -translate-y-1/2 absolute -left-10">
          <div className="absolute inset-0">
            <span
              id="style-85zWm"
              className="inline-block bg-black  style-85zWm"
            ></span>
            <span
              id="style-LbmUy"
              className="inline-block bg-black  style-LbmUy"
            ></span>
            <span
              id="style-OTex5"
              className="inline-block bg-black  style-OTex5"
            ></span>
            <span
              id="style-oUEf7"
              className="inline-block bg-black  style-oUEf7"
            ></span>
            <span
              id="style-9lwEF"
              className="inline-block bg-black  style-9lwEF"
            ></span>
            <span
              id="style-VSPhh"
              className="inline-block bg-black  style-VSPhh"
            ></span>
            <span
              id="style-YKMZp"
              className="inline-block bg-black  style-YKMZp"
            ></span>
            <span
              id="style-D4K7j"
              className="inline-block bg-black  style-D4K7j"
            ></span>
            <span
              id="style-61SdM"
              className="inline-block bg-black  style-61SdM"
            ></span>
            <span
              id="style-xcj7O"
              className="inline-block bg-black  style-xcj7O"
            ></span>
            <span
              id="style-P6qK5"
              className="inline-block bg-black style-P6qK5"
            ></span>
            <span
              id="style-XRDvo"
              className="inline-block bg-black  style-XRDvo"
            ></span>
          </div>
        </div>
      </div>
